...
static struct GUID_Entry guid_names[] = {
    ...
    GUID_ENTRY(MF_SA_MINIMUM_OUTPUT_SAMPLE_COUNT),
    GUID_ENTRY(MF_SA_MINIMUM_OUTPUT_SAMPLE_COUNT_PROGRESSIVE),
    GUID_ENTRY(MF_SA_D3D11_BINDFLAGS),
    GUID_ENTRY(MF_SA_D3D11_USAGE),
    GUID_ENTRY(MF_SA_D3D11_AWARE),
    GUID_ENTRY(MF_SA_D3D11_SHARED),
    GUID_ENTRY(MF_SA_D3D11_SHARED_WITHOUT_MUTEX),
    ...
    GUID_ENTRY(CODECAPI_AVDecVideoThumbnailGenerationMode),
    GUID_ENTRY(CODECAPI_AVDecVideoDropPicWithMissingRef),
    GUID_ENTRY(CODECAPI_AVDecVideoSoftwareDeinterlaceMode),
    GUID_ENTRY(CODECAPI_AVDecVideoFastDecodeMode),
    GUID_ENTRY(CODECAPI_AVLowLatencyMode),
    GUID_ENTRY(CODECAPI_AVDecVideoH264ErrorConcealment),
    GUID_ENTRY(CODECAPI_AVDecVideoMPEG2ErrorConcealment),
    GUID_ENTRY(CODECAPI_AVDecVideoCodecType),
    GUID_ENTRY(CODECAPI_AVDecVideoDXVAMode),
    GUID_ENTRY(CODECAPI_AVDecVideoDXVABusEncryption),
    GUID_ENTRY(CODECAPI_AVDecVideoSWPowerLevel),
    GUID_ENTRY(CODECAPI_AVDecVideoMaxCodedWidth),
    GUID_ENTRY(CODECAPI_AVDecVideoMaxCodedHeight),
    GUID_ENTRY(CODECAPI_AVDecNumWorkerThreads),
    GUID_ENTRY(CODECAPI_AVDecSoftwareDynamicFormatChange),
    GUID_ENTRY(CODECAPI_AVDecDisableVideoPostProcessing),
};
